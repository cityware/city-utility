...
class GeoIpV1 {
        ...
        if ($this->flags & GEOIP_SHARED_MEMORY) {
            ...
            for ($i = 0; $i < STRUCTURE_INFO_MAX_SIZE; $i++) {
                ...
                if ($delim == (chr(255) . chr(255) . chr(255))) {
                    ...
                    if ($this->databaseType == GEOIP_REGION_EDITION_REV0) {
                    ...
                    } elseif (($this->databaseType == GEOIP_CITY_EDITION_REV0) || ($this->databaseType == GEOIP_CITY_EDITION_REV1) || ($this->databaseType == GEOIP_ORG_EDITION) || ($this->databaseType == GEOIP_ORG_EDITION_V6) || ($this->databaseType == GEOIP_DOMAIN_EDITION) || ($this->databaseType == GEOIP_DOMAIN_EDITION_V6) || ($this->databaseType == GEOIP_ISP_EDITION) || ($this->databaseType == GEOIP_ISP_EDITION_V6) || ($this->databaseType == GEOIP_USERTYPE_EDITION) || ($this->databaseType == GEOIP_USERTYPE_EDITION_V6) || ($this->databaseType == GEOIP_LOCATIONA_EDITION) || ($this->databaseType == GEOIP_ACCURACYRADIUS_EDITION) || ($this->databaseType == GEOIP_CITY_EDITION_REV0_V6) || ($this->databaseType == GEOIP_CITY_EDITION_REV1_V6) || ($this->databaseType == GEOIP_NETSPEED_EDITION_REV1) || ($this->databaseType == GEOIP_NETSPEED_EDITION_REV1_V6) || ($this->databaseType == GEOIP_ASNUM_EDITION) || ($this->databaseType == GEOIP_ASNUM_EDITION_V6)
                    ) {
                        ...
                        if (($this->databaseType == GEOIP_ORG_EDITION) || ($this->databaseType == GEOIP_ORG_EDITION_V6) || ($this->databaseType == GEOIP_DOMAIN_EDITION) || ($this->databaseType == GEOIP_DOMAIN_EDITION_V6) || ($this->databaseType == GEOIP_ISP_EDITION) || ($this->databaseType == GEOIP_ISP_EDITION_V6)
                        ) {
            ...
            for ($i = 0; $i < STRUCTURE_INFO_MAX_SIZE; $i++) {
                ...
                if ($delim == (chr(255) . chr(255) . chr(255))) {
                    ...
                    if ($this->databaseType == GEOIP_REGION_EDITION_REV0) {
                        ...
                        $this->databaseSegments = GEOIP_STATE_BEGIN_REV1;
                    } elseif (($this->databaseType == GEOIP_CITY_EDITION_REV0) || ($this->databaseType == GEOIP_CITY_EDITION_REV1) || ($this->databaseType == GEOIP_CITY_EDITION_REV0_V6) || ($this->databaseType == GEOIP_CITY_EDITION_REV1_V6) || ($this->databaseType == GEOIP_ORG_EDITION) || ($this->databaseType == GEOIP_DOMAIN_EDITION) || ($this->databaseType == GEOIP_ISP_EDITION) || ($this->databaseType == GEOIP_ORG_EDITION_V6) || ($this->databaseType == GEOIP_DOMAIN_EDITION_V6) || ($this->databaseType == GEOIP_ISP_EDITION_V6) || ($this->databaseType == GEOIP_LOCATIONA_EDITION) || ($this->databaseType == GEOIP_ACCURACYRADIUS_EDITION) || ($this->databaseType == GEOIP_CITY_EDITION_REV0_V6) || ($this->databaseType == GEOIP_CITY_EDITION_REV1_V6) || ($this->databaseType == GEOIP_NETSPEED_EDITION_REV1) || ($this->databaseType == GEOIP_NETSPEED_EDITION_REV1_V6) || ($this->databaseType == GEOIP_USERTYPE_EDITION) || ($this->databaseType == GEOIP_USERTYPE_EDITION_V6) || ($this->databaseType == GEOIP_ASNUM_EDITION) || ($this->databaseType == GEOIP_ASNUM_EDITION_V6)
                    ) {
                        $this->databaseSegments = 0;
                        ...
                        if (($this->databaseType == GEOIP_ORG_EDITION) || ($this->databaseType == GEOIP_DOMAIN_EDITION) || ($this->databaseType == GEOIP_ISP_EDITION) || ($this->databaseType == GEOIP_ORG_EDITION_V6) || ($this->databaseType == GEOIP_DOMAIN_EDITION_V6) || ($this->databaseType == GEOIP_ISP_EDITION_V6)
                        ) {
                            $this->record_length = ORG_RECORD_LENGTH;
                        }
                    }
    ...
    private function _geoip_seek_country_v6($ipnum) {
        ...
        for ($depth = 127; $depth >= 0; --$depth) {
            if ($this->flags & GEOIP_MEMORY_CACHE) {
                $buf = $this->_safe_substr($this->memory_buffer, 2 * $this->record_length * $offset, 2 * $this->record_length);
            } elseif ($this->flags & GEOIP_SHARED_MEMORY) {
                $buf = $this->_sharedMemRead(2 * $this->record_length * $offset, 2 * $this->record_length);
            } else {
                fseek($this->filehandle, 2 * $this->record_length * $offset, SEEK_SET) == 0 or trigger_error("GeoIP API: fseek failed", E_USER_ERROR);
