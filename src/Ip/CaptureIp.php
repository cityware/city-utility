...
class CaptureIp
{
     ...
     */
    private $Private_IP_Normal = '0.0.0.0/8, 1.0.0.0/8, 2.0.0.0/8, 10.0.0.0/8,
                              127.0.0.0/8, 169.254.0.0/16, 172.16.0.0/12, 192.0.2.0/24,
                              192.168.0.0/24, 198.18.0.0/15, 224.0.0.0/3';
    /*
    ...
    */
     ...
     */
    private $Private_IP_Extended = '0.0.0.0/8, 1.0.0.0/8, 2.0.0.0/8, 5.0.0.0/8,
    ...
    private $exfile = ''; //Load Extended Private IP Address List from this file (will overwrite existing list)

    public $ex_private = false; //Use Extended List in private IP detection
    public $ex_proxy = false; //Use Extended List in proxy (client IP) detection
    ...
    private $Proxy_Evidence = array (/**
            ...
            */
            ...
            array ('HTTP_MAX_FORWARDS', XIP_HT_None, true ), //array('HTTP_FROM', XIP_HT_ClientIP, true,'value'=>'/(\d{1,3}\.){3}\d{1,3}/'), //proxy is detected if header contains IP
            ...
            array ('HTTP_X_BLUECOAT_VIA', XIP_HT_PName, true ), //search inside REMOTE_HOST
            /*
            ...
            */
            ...
            array ('REMOTE_HOST', XIP_HT_None, true, 'value' => '/proxy.*\..*\..*/' ), //Yes, if remote host contains something like cache123.example.com
            array ('REMOTE_HOST', XIP_HT_None, true, 'value' => '/cache.*\..*\..*/' ), //Guess Unknown headers using Regular expressions
     ...
     */
    public function NetCheck($ip, $networks)
    {
        return $this->CheckNet ( $networks, $ip );
    }
    ...
    public function __construct()
    {
        ...
        foreach ($this->Proxy_Evidence as $value) {
            ...
            foreach ($tmp as $hkey => $hvalue) {
                ...
                if(isset($this->Proxy ['headers']['HTTP_X_FORWARDED_FOR']) and $this->Proxy ['headers']['HTTP_X_FORWARDED_FOR'] != "")
                    $clientProxy = $this->Proxy ['headers']['HTTP_X_FORWARDED_FOR'];
            }
        }
        ...
        $this->IP ['clientProxy'] = $clientProxy;
